...
import { useCreateBackgroundRemovalPriceMutation, useDeleteBackgroundRemovalPriceMutation, useGetAllBackgroundRemovalPriceQuery, useUpdateBackgroundRemovalPriceMutation } from "../../../features/BackgroundRemovalService/backgroundRemovalPrice/backgroundRemovalPrice";
import axios from "axios";

const BackgroundRemovalPrice = () => {
  ...
  const [createBackgroundRemovalPrice] = useCreateBackgroundRemovalPriceMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createBackgroundRemovalPrice(formData);
      if (res) {
  ...
  const [updateBackgroundRemovalPrice] = useUpdateBackgroundRemovalPriceMutation();
  ...
  // const { data, isLoading, isError, error } = useGetAllBackgroundRemovalPriceQuery();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://photo-editing-backend.onrender.com/api/v1/backgroundRemovalPrice'); // Replace with your API endpoint
  ...
  const [deleteBackgroundRemovalPrice] = useDeleteBackgroundRemovalPriceMutation();
...
export default BackgroundRemovalPrice;
