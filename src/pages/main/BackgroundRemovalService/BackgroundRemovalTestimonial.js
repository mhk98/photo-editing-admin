...
import { useCreateBackgroundRemovalTestimonialMutation, useDeleteBackgroundRemovalTestimonialMutation, useGetAllBackgroundRemovalTestimonialQuery, useUpdateBackgroundRemovalTestimonialMutation } from "../../../features/BackgroundRemovalService/backgroundRemovalTestimonial/backgroundRemovalTestimonial";
import axios from "axios";


const BackgroundRemovalTestimonial = () => {
  ...
  const [createBackgroundRemovalTestimonial] = useCreateBackgroundRemovalTestimonialMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createBackgroundRemovalTestimonial(formData);
      if (res) {
  ...
  const [updateBackgroundRemovalTestimonial] = useUpdateBackgroundRemovalTestimonialMutation();
  ...
  // const { data, isLoading, isError, error } = useGetAllBackgroundRemovalTestimonialQuery();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://82.112.226.90:5000/api/v1/backgroundRemovalTestimonial'); // Replace with your API endpoint
  ...
  const [deleteBackgroundRemovalTestimonial] = useDeleteBackgroundRemovalTestimonialMutation();
...
export default BackgroundRemovalTestimonial;
