...
import { useCreateBackgroundRemovalMutation, useDeleteBackgroundRemovalMutation, useGetAllBackgroundRemovalQuery, useUpdateBackgroundRemovalMutation } from "../../../features/BackgroundRemovalService/backgroundRemoval/backgroundRemoval";
...
const BackgroundRemoval = () => {
  ...
  const [createBackgroundRemoval] = useCreateBackgroundRemovalMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createBackgroundRemoval(formData);
      if (res) {
  ...
  const [updateBackgroundRemoval] = useUpdateBackgroundRemovalMutation();
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updateBackgroundRemoval({ id: updateId, data: formData });
      if (res) {
  ...
  const { data, isLoading, isError, error } = useGetAllBackgroundRemovalQuery();
  ...
  const [deleteBackgroundRemoval] = useDeleteBackgroundRemovalMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deleteBackgroundRemoval(id);
