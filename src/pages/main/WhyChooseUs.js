...
} from "../../features/whyChooseUs/whyChooseUs";
...
const WhyChooseUs = () => {
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createWhyChooseUs(formData);
      if (res) {
  ...
  const [updateWhyChooseUs] = useUpdateWhyChooseUsMutation();
  ...
  const { data, isLoading, isError, error } = useGetAllWhyChooseUsQuery();
