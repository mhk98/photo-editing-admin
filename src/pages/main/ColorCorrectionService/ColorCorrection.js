...
import { useCreateColorCorrectionMutation, useDeleteColorCorrectionMutation, useGetAllColorCorrectionQuery, useUpdateColorCorrectionMutation } from "../../../features/ColorCorrectionService/colorCorrection/colorCorrection";
import axios from "axios";
// import { , useUpdateColorCorrectionMutation } from "../../../features/ColorCorrectionService/clippingPath/clippingPath";
...
const ColorCorrection = () => {
  ...
  const [createColorCorrection] = useCreateColorCorrectionMutation();
  ...
  const [updateColorCorrection] = useUpdateColorCorrectionMutation();
  ...
  // const { data, isLoading, isError, error } = useGetAllColorCorrectionQuery();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://photo-editing-backend.onrender.com/api/v1/colorCorrection'); // Replace with your API endpoint
  ...
  const [deleteColorCorrection] = useDeleteColorCorrectionMutation();
