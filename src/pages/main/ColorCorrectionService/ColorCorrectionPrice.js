...
import { useCreatecolorCorrectionPriceMutation, useDeletecolorCorrectionPriceMutation, useGetAllcolorCorrectionPriceQuery, useUpdatecolorCorrectionPriceMutation } from "../../../features/ColorCorrectionService/colorCorrectionPrice/colorCorrectionPrice";
import axios from "axios";

const ColorCorrectionPrice = () => {
  ...
  const [createcolorCorrectionPrice] = useCreatecolorCorrectionPriceMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createcolorCorrectionPrice(formData);
      if (res) {
  ...
  const [updatecolorCorrectionPrice] = useUpdatecolorCorrectionPriceMutation();
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updatecolorCorrectionPrice({ id: updateId, data: formData });
      if (res) {
  ...
  // const { data, isLoading, isError, error } = useGetAllcolorCorrectionPriceQuery();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://api.pixamoss.com/api/v1/colorCorrectionPrice'); // Replace with your API endpoint
  ...
  const [deletecolorCorrectionPrice] = useDeletecolorCorrectionPriceMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deletecolorCorrectionPrice(id);
...
export default ColorCorrectionPrice;
