...
import { useCreateghostMannequinPriceMutation, useDeleteghostMannequinPriceMutation, useGetAllghostMannequinPriceQuery, useUpdateghostMannequinPriceMutation } from "../../../features/GhostMannequinService/ghostMannequinPrice/ghostMannequinPrice";

const GhostMannequinPrice = () => {
  ...
  const [createghostMannequinPrice] = useCreateghostMannequinPriceMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createghostMannequinPrice(formData);
      if (res) {
  ...
  const [updateghostMannequinPrice] = useUpdateghostMannequinPriceMutation();
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updateghostMannequinPrice({ id: updateId, data: formData });
      if (res) {
  ...
  const { data, isLoading, isError, error } = useGetAllghostMannequinPriceQuery();
  ...
  const [deleteghostMannequinPrice] = useDeleteghostMannequinPriceMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deleteghostMannequinPrice(id);
...
export default GhostMannequinPrice;
