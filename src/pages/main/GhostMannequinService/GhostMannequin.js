...
import { useCreateghostMannequinMutation, useDeleteghostMannequinMutation, useGetAllghostMannequinQuery, useUpdateghostMannequinMutation } from "../../../features/GhostMannequinService/ghostMannequin/ghostMannequin";
...
const GhostMannequin = () => {
  ...
  const [createghostMannequin] = useCreateghostMannequinMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createghostMannequin(formData);
      if (res) {
  ...
  const [updateghostMannequin] = useUpdateghostMannequinMutation();
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updateghostMannequin({ id: updateId, data: formData });
      if (res) {
  ...
  const { data, isLoading, isError, error } = useGetAllghostMannequinQuery();
  ...
  const [deleteghostMannequin] = useDeleteghostMannequinMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deleteghostMannequin(id);
