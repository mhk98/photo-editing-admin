...
import { useCreateghostMannequinTestimonialMutation, useDeleteghostMannequinTestimonialMutation, useGetAllghostMannequinTestimonialQuery, useUpdateghostMannequinTestimonialMutation } from "../../../features/GhostMannequinService/ghostMannequinTestimonial/ghostMannequinTestimonial";


const GhostMannequinTestimonial = () => {
  ...
  const [createghostMannequinTestimonial] = useCreateghostMannequinTestimonialMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createghostMannequinTestimonial(formData);
      if (res) {
  ...
  const [updateClippingPathTestimonial] = useUpdateghostMannequinTestimonialMutation();
  ...
  const { data, isLoading, isError, error } = useGetAllghostMannequinTestimonialQuery();
  ...
  const [deleteClippingPathTestimonial] = useDeleteghostMannequinTestimonialMutation();
...
export default GhostMannequinTestimonial;
