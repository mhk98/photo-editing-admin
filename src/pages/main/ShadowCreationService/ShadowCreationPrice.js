...
import { useCreateshadowCreationPriceMutation, useDeleteshadowCreationPriceMutation, useGetAllshadowCreationPriceQuery, useUpdateshadowCreationPriceMutation } from "../../../features/ShadowCreation/shadowCreationPrice/shadowCreationPrice";

const ShadowCreationPrice = () => {
  ...
  const [createshadowCreationPrice] = useCreateshadowCreationPriceMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createshadowCreationPrice(formData);
      if (res) {
  ...
  const [updateshadowCreationPrice] = useUpdateshadowCreationPriceMutation();
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updateshadowCreationPrice({ id: updateId, data: formData });
      if (res) {
  ...
  const { data, isLoading, isError, error } = useGetAllshadowCreationPriceQuery();
  ...
  const [deleteshadowCreationPrice] = useDeleteshadowCreationPriceMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deleteshadowCreationPrice(id);
...
export default ShadowCreationPrice;
