...
import { useCreateAutomotiveMutation, useDeleteAutomotiveMutation, useGetAllAutomotiveQuery, useUpdateAutomotiveMutation } from "../../../features/AutomotiveService/automotive/automotive";
...
const Automotive = () => {
  ...
  const [createAutomotive] = useCreateAutomotiveMutation();
  ...
  const onFormSubmit = async () => {
    ...
    try {
      const res = await createAutomotive(formData);
      if (res) {
  ...
  const onFormEdit = async () => {
    ...
    try {
      const res = await updateAutomotive({ id: updateId, data: formData });
      if (res) {
  ...
  const { data, isLoading, isError, error } = useGetAllAutomotiveQuery();
  ...
  const [deleteAutomotive] = useDeleteAutomotiveMutation();

  const handleDeleteHomeBanner = async (id) => {
    const res = await deleteAutomotive(id);
